...
X=scale(X)
y_raw=protein_data.get('label')#obtain the label
...
yscore_sum.to_csv('yscore_sum_SVC.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_SVC.csv')
...
data_csv.to_csv('protein_SVC_result.csv')
